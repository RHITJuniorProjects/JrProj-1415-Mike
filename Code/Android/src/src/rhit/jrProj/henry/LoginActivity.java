...
//	private UserLoginTask mAuthTask = null;
    ...
    private Firebase ref=new Firebase("https://shining-inferno-2277.firebaseio.com/");
...
//		}
	...
	private void setAuthenticatedUser(AuthData authData) {
        if (authData != null) {
                ...
                Log.i("authData status", new Boolean(this.authData==null).toString());
...
//        mAuthProgressDialog.show();
		Log.i("T", "T2");
        ref.authWithPassword(username, password, new AuthResultHandler("password"));
    }
